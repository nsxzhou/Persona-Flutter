...
mixin _$WritingProject {
 ...
 String get id; String get title; String get description; ProjectStatus get status; String? get defaultProviderId; String? get defaultModelName; String? get styleProfileId; String? get plotProfileId; ProjectOrigin get origin; String get language; int get targetLength; int get totalTargetLength; String get narrativePerspective; bool get useHighQualityGeneration; DateTime get createdAt; DateTime get updatedAt;
...
@useResult
$Res call({
 String id, String title, String description, ProjectStatus status, String? defaultProviderId, String? defaultModelName, String? styleProfileId, String? plotProfileId, ProjectOrigin origin, String language, int targetLength, int totalTargetLength, String narrativePerspective, bool useHighQualityGeneration, DateTime createdAt, DateTime updatedAt
});
...
as ProjectOrigin,language: null == language ? _self.language : language // ignore: cast_nullable_to_non_nullable
...
as String,useHighQualityGeneration: null == useHighQualityGeneration ? _self.useHighQualityGeneration : useHighQualityGeneration // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _WritingProject() when $default != null:
return $default(_that.id,_that.title,_that.description,_that.status,_that.defaultProviderId,_that.defaultModelName,_that.styleProfileId,_that.plotProfileId,_that.origin,_that.language,_that.targetLength,_that.totalTargetLength,_that.narrativePerspective,_that.useHighQualityGeneration,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
class _WritingProject implements WritingProject {
  const _WritingProject({required this.id, required this.title, this.description = '', required this.status, this.defaultProviderId, this.defaultModelName, this.styleProfileId, this.plotProfileId, this.origin = ProjectOrigin.standard, this.language = defaultProjectLanguage, this.targetLength = defaultProjectTargetLength, this.totalTargetLength = defaultProjectTotalTargetLength, this.narrativePerspective = defaultProjectNarrativePerspective, this.useHighQualityGeneration = true, required this.createdAt, required this.updatedAt});
...
@override@JsonKey() final  ProjectOrigin origin;
...
@override@JsonKey() final  bool useHighQualityGeneration;
